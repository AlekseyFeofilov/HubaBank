...
final class CreateEmployeeViewController: BaseViewController, TabBarHiding {
	// MARK: - Init

	init(viewModel: CreateEmployeeViewModel) {
	...
	private let viewModel: CreateEmployeeViewModel
