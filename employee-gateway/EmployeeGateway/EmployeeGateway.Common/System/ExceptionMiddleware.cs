    ...
    public async Task Invoke(HttpContext context)
    {
        ...
        catch (MaxCountException exception)
        {
            ...
            await context.Response.WriteAsJsonAsync(new ErrorResponse
                { StatusCode = 504, Message = exception.Message });
        }
        catch (IncorrectDataException exception)
        {
            ...
            await context.Response.WriteAsJsonAsync(new ErrorResponse
                { StatusCode = 400, Message = exception.Message });
        }
        catch (ForbiddenException exception)
        {
            ...
            await context.Response.WriteAsJsonAsync(new ErrorResponse
                { StatusCode = 403, Message = exception.Message });
        }
        catch (NotFoundItemException exception)
        {
            ...
            await context.Response.WriteAsJsonAsync(new ErrorResponse
                { StatusCode = 404, Message = exception.Message });
        }
        catch (Exception e)
        {
